...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3424 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2104 ;
...
CREATE TABLE IF NOT EXISTS `status` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=55769 ;
